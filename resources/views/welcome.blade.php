                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="h5 russo">
                            ...
                            <div class="py-1">
                                <span class="fa fa-fw fa-check"></span>&nbsp;Автор кулинарии нового тысячилетия &quot;Живая Кухня&quot;
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="container">
                            ...
                            <form action="/lead" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="">
                                        <button type="submit" class="sw btn-circle btn btn-primary btn-block">Получить бесплатно</button>
                                    </div>
                                </div>
                            </form>
